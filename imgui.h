...
typedef int ImGuiCenteredFlags;     // -> enum ImGuiCenteredFlags_   // Flags: for CenteredXXX Functions
...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, ImTextureID icon_texture = 0, int titleheight = 0);
    IMGUI_API void          End();
    ...
    IMGUI_API void          Splitter(const char* name, bool split_vertically, float thickness, float* size);  // splitter
    ...
    IMGUI_API void          LabelAligned(const char* label, ImGuiCenteredFlags flags = ImGuiCenteredFlags_Horizontal, const ImVec2& align = ImVec2(0.5f, 0.5f)); // display text aligned the same way as value+label widgets
    ...
    IMGUI_API void          ImageAligned(ImTextureID user_texture_id, const ImVec2& image_size, ImGuiCenteredFlags flags = ImGuiCenteredFlags_Horizontal, const ImVec2& align = ImVec2(0.5f, 0.5f), const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_LargeColorOnly  = 1 << 29,  // [Input]      // ColorEdit, ColorPicker: input and output data in HSV format.
