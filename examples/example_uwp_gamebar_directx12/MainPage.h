...
namespace winrt::example_uwp_gamebar_directx12::implementation
{
    struct MainPage : MainPageT<MainPage>
    {
		...
		ImVec4 m_clear_color = ImVec4(0.45f, 0.55f, 0.60f, 0.00f);
		...
		void InitDevice(winrt::Windows::UI::Core::CoreWindow const& window);
		void OnSizeChanged(IInspectable const&, winrt::Windows::UI::Core::WindowSizeChangedEventArgs const& args);
...
namespace winrt::example_uwp_gamebar_directx12::factory_implementation
{
