Thanks for installing the Game Bar NuGet package!

BREAKING CHANGE:
XboxGameBarForegroundWorker has moved from Microsoft.Gaming.XboxGameBar.Restricted to Microsoft.Gaming.XboxGameBar.
Please update your code accordingly to successfully compile. The API is now unrestricted.

IMPORTANT: Please add the following XML to your package.appxmanifest file of your project.  This might be updated when
we update the NuGet package, so please double check if you need to copy it again. 

This <Extensions> element goes after your
</Applications> end element but before your <Capabilities> element.  NOTE: This is not the same <Extensions> section
where you put the AppExtension.  The extension below is Package level whereas the AppExtension is at the App level.
This step will hopefully be removed in a future release of the NuGet.
